...
# v0.60 hidden room — biggest payout in the game (12 coins). See stage_2
# for the layout shape.
...
func _return_to_title() -> void:
	if not is_inside_tree():
		return
	Game.return_to_base_or_title("stage_5", true)
